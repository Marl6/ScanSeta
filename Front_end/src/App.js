...
function App() {
  ...
  const goToDashboard2 = () => setCurrentDashboard(2);
  const goToDashboard3 = () => setCurrentDashboard(3);
  const goToMedInfo = () => setCurrentDashboard(4); // New function for MedInfo

  return (
    <div className="App">
      {currentDashboard === 1 && <Dashboard1 goToDashboard2={goToDashboard2} goToDashboard3={goToDashboard3} />}
      {currentDashboard === 2 && <Dashboard2 goNext={goToDashboard3} goBack={goToDashboard1} />}
      {currentDashboard === 3 && <Dashboard3 goBack={goToDashboard1} goNext={goToMedInfo} />} {/* Pass goNext to Dashboard3 */}
      {currentDashboard === 4 && <MedInfo goBack={goToDashboard3} />} {/* MedInfo Component */}
    </div>
  );
}
